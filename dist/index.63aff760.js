...
var _creditcardJs = require("./node_modules/creditcard.js");
...
(()=>{
    ...
    function createPaymentFormsContainer() {
        const paymentDataContainer = (0, _redom.el)(".payment-details-container");
        const paymentFormRight = (0, _redom.el)("form.payment-form payment-form_right");
        const paymentFormLabelCardNumber = (0, _redom.el)("label.payment-form__label_card-number", "Card number");
        (0, _redom.mount)(paymentFormLabelCardNumber, (0, _redom.el)("input.payment-form__input_card-number#payment-form__input_card-number", {
            maxlength: "24",
            placeholder: "0000 0000 0000 0000"
        }));
        const paymentFormLabelCardholderFullname = (0, _redom.el)("label.payment-form__label_card-holder", "Cardholder fullname");
        (0, _redom.mount)(paymentFormLabelCardholderFullname, (0, _redom.el)("input.payment-form__input_card-holder#payment-form__input_card-holder"));
        const paymentFormDiv\u0421onsolidation = (0, _redom.el)(".payment-form__div-exdate-email");
        const paymentFormLabelExpirationDate = (0, _redom.el)("label.payment-form__label_expiration-date", "Expiration date");
        (0, _redom.mount)(paymentFormLabelExpirationDate, (0, _redom.el)("input.payment-form__input_expiration-date#payment-form__input_expiration-date", {
            placeholder: "MM/YY",
            maxlength: "5"
        }));
        const paymentFormLabelEmail = (0, _redom.el)("label.payment-form__label_email", "Email");
        (0, _redom.mount)(paymentFormLabelEmail, (0, _redom.el)("input.payment-form__input_email#payment-form__input_email", {
            type: "email"
        }));
        (0, _redom.setChildren)(paymentFormDiv\u0421onsolidation, [
            paymentFormLabelExpirationDate,
            paymentFormLabelEmail
        ]);
        (0, _redom.setChildren)(paymentFormRight, [
            paymentFormLabelCardNumber,
            paymentFormLabelCardholderFullname,
            paymentFormDiv\u0421onsolidation
        ]);
        const paymentFormLeft = (0, _redom.el)("form.payment-form payment-form_left");
        const paymentFormLabelSecurityCode = (0, _redom.el)("label.payment-form__label_security-code", "Security code");
        (0, _redom.mount)(paymentFormLabelSecurityCode, (0, _redom.el)("input.payment-form__input_security-code#payment-form__input_security-code", {
            placeholder: "CVC/CVV",
            maxlength: "3"
        }));
        (0, _redom.setChildren)(paymentFormLeft, [
            (0, _redom.el)(".payment-form__left-div"),
            paymentFormLabelSecurityCode,
            (0, _redom.el)(".payment-form__card-type-div#payment-form__card-type-div")
        ]);
        (0, _redom.setChildren)(paymentDataContainer, [
            paymentFormRight,
            paymentFormLeft
        ]);
    ...
    function createSavePaymentMethodCheckbox() {
        const savePaymentMethodLabel = (0, _redom.el)("label.save-payment-method-label");
        (0, _redom.setChildren)(savePaymentMethodLabel, [
            (0, _redom.el)("input.save-payment-method-input", {
                type: "checkbox"
            }),
            (0, _redom.el)("span.save-payment-method-span", "Save your card for future payments")
        ]);
        return savePaymentMethodLabel;
    }
    function createConfirmPaymentButton() {
        return (0, _redom.el)("button.confirm-payment-button#confirm-payment-button", "Pay", {
            disabled: "true"
        });
    }
    (0, _redom.setChildren)(container, [
        createPaymentFormsContainer(),
        createSavePaymentMethodCheckbox(),
        createConfirmPaymentButton()
    ]);
    ...
    [
        fullnameInput,
        emailInput
    ].forEach((input)=>maskForTextInputs(input));
    ...
    (0, _inputmaskDefault.default)("99/99", {
        showMaskOnHover: false
    }).mask(expirationDateInput);
    (0, _inputmaskDefault.default)("999", {
        showMaskOnHover: false
    }).mask(securityCodeInput);
    //Validation
    const cardNumberTip = (0, _tippyJsDefault.default)(cardNumberInput, {
    ...
    const fullnameTip = (0, _tippyJsDefault.default)(fullnameInput, {
    ...
    const expirationDateTip = (0, _tippyJsDefault.default)(expirationDateInput, {
    ...
    const emailTip = (0, _tippyJsDefault.default)(emailInput, {
    ...
    const securityCodeTip = (0, _tippyJsDefault.default)(securityCodeInput, {
    ...
    cardNumberInput.addEventListener("blur", ()=>{
        if (!(0, _creditcardJs.isValid)(cardNumberInput.value.replaceAll(" ", ""))) cardNumberTip.show();
        const cardTypeClass = cardTypesMap.get((0, _creditcardJs.getCreditCardNameByNumber)(cardNumberInput.value.replaceAll(" ", "")));
        cardTypeDiv.classList.add(cardTypeClass);
    });
    cardNumberInput.addEventListener("input", ()=>{
        cardNumberTip.hide();
        cardTypeDiv.classList.remove(...[
            ...cardTypeDiv.classList
        ].filter((n)=>n !== "payment-form__card-type-div"));
    });
    fullnameInput.addEventListener("blur", ()=>{
        if (!isTextInputsValid(fullnameInput)) fullnameTip.show();
    });
    fullnameInput.addEventListener("input", ()=>{
        fullnameTip.hide();
    });
    expirationDateInput.addEventListener("blur", ()=>{
        if (!(0, _creditcardJs.isExpirationDateValid)(expirationDateInput.value.replaceAll("/", "").substring(0, 2), "20" + expirationDateInput.value.replaceAll("/", "").substring(2, 4))) expirationDateTip.show();
    });
    expirationDateInput.addEventListener("input", ()=>{
        expirationDateTip.hide();
    });
    emailInput.addEventListener("blur", ()=>{
        if (!isTextInputsValid(emailInput) || !isEmailValid(emailInput.value)) emailTip.show();
    });
    emailInput.addEventListener("input", ()=>{
        if (!isNaN(emailInput.value[0])) emailInput.value = "";
        if (emailInput.value[0] === "@") emailInput.value = "";
        emailTip.hide();
    });
    securityCodeInput.addEventListener("blur", ()=>{
        if (!(0, _creditcardJs.isSecurityCodeValid)(cardNumberInput.value.replaceAll(" ", ""), securityCodeInput.value)) securityCodeTip.show();
    });
    securityCodeInput.addEventListener("input", ()=>{
        securityCodeTip.hide();
    });
    function validation() {
        return (0, _creditcardJs.isValid)(cardNumberInput.value.replaceAll(" ", "")) && isTextInputsValid(fullnameInput) && (0, _creditcardJs.isExpirationDateValid)(expirationDateInput.value.replaceAll("/", "").substring(0, 2), "20" + expirationDateInput.value.replaceAll("/", "").substring(2, 4)) && isTextInputsValid(emailInput) && isEmailValid(emailInput.value) && (0, _creditcardJs.isSecurityCodeValid)(cardNumberInput.value.replaceAll(" ", ""), securityCodeInput.value);
    }
    [
        cardNumberInput,
        fullnameInput,
        ...
        input.addEventListener("blur", ()=>{
            ...
            if ((0, _creditcardJs.isValid)(cardNumberInput.value.replaceAll(" ", ""))) cardNumberTip.hide();
            if (isTextInputsValid(fullnameInput)) fullnameTip.hide();
            if ((0, _creditcardJs.isExpirationDateValid)(expirationDateInput.value.replaceAll("/", "").substring(0, 2), "20" + expirationDateInput.value.replaceAll("/", "").substring(2, 4))) expirationDateTip.hide();
            if ((0, _creditcardJs.isSecurityCodeValid)(cardNumberInput.value.replaceAll(" ", ""), securityCodeInput.value)) securityCodeTip.hide();
            if (isTextInputsValid(emailInput) && isEmailValid(emailInput.value)) emailTip.hide();
        });
    });
})();

},{"./node_modules/redom":"cWIuY","./node_modules/creditcard.js":"lyHGp","tippy.js":"ccpCS","tippy.js/dist/tippy.css":"2hEyg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","inputmask":"gyYno"}],"cWIuY":[function(require,module,exports) {
...
},{}],"ccpCS":[function(require,module,exports) {
/**!
* tippy.js v6.3.7
* (c) 2017-2021 atomiks
* MIT License
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","./modifiers/offset.js":"3GKVY","./modifiers/flip.js":"fv5wq","./modifiers/preventOverflow.js":"1AMhb","./modifiers/arrow.js":"31HFW","./modifiers/hide.js":"2g4OF","./popper-lite.js":false,"./modifiers/index.js":false,"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2hEyg":[function() {},{}],"gyYno":[function(require,module,exports) {
/*!
 * dist/inputmask
                    ...
                    numeric: {
                        ...
                        onKeyDown: function(e, t, i, a) {
                            ...
                            if (!e.shiftKey && (e.keyCode === n.default.DELETE || e.keyCode === n.default.BACKSPACE || e.keyCode === n.default.BACKSPACE_SAFARI) && i.begin !== t.length) {
                                if (t[e.keyCode === n.default.DELETE ? i.begin - 1 : i.end] === a.negationSymbol.front) return r = t.slice().reverse(), "" !== a.negationSymbol.front && r.shift(), "" !== a.negationSymbol.back && r.pop(), o.trigger("setvalue", [
                                    r.join(""),
                                    i.begin
                                ]), !1;
                                if (!0 === a._radixDance) {
                                    ...
                                    if (a.digitsOptional) {
                                        if (0 === f) return (r = t.slice().reverse()).pop(), o.trigger("setvalue", [
                                            r.join(""),
                                            i.begin >= r.length ? r.length : i.begin
                                        ]), !1;
                                    } else if (-1 !== f && (i.begin < f || i.end < f || e.keyCode === n.default.DELETE && (i.begin === f || i.begin - 1 === f))) {
                                        var d = void 0;
                                        return i.begin === i.end && (e.keyCode === n.default.BACKSPACE || e.keyCode === n.default.BACKSPACE_SAFARI ? i.begin++ : e.keyCode === n.default.DELETE && i.begin - 1 === f && (d = s.extend({}, i), i.begin--, i.end--)), (r = t.slice().reverse()).splice(r.length - i.begin, i.begin - i.end + 1), r = c(r, a.digits, a).join(""), d && (i = d), o.trigger("setvalue", [
                                            r,
...
},{}]},["6DoTH","adjPd"], "adjPd", "parcelRequired699")
